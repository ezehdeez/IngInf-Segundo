...
x<-3
plot(x, ddiscunif(x,size=9), ylim=c(0,0.12), xlim=c(1,9),type = "h", lwd=3, col="blue",lab=c(9,7,7),main="Distribución Uniforme (1:9)",xlab="valores")
ddiscunif(3,size=9)   # valor de la probabilidad en 3
...
qbinom(0.6,12, 0.25)    # cuantil de orden 0.6 de la binomial utilizada (punto crítico)
...
# el número de fracasos necesarios hasta tener el primer éxito= 0, 1, 2, 3

dgeom(0:100,0.25)   # valor de la probabilidad en los primeros valores
...
#gráfica de la funciÃón de distribución para los cuantiles solicitados
x<-0:70
...
qhyper(0.40,3,6,5)  # cuantil de orden 0.4 de la Hipergeométrica utilizada (punto crítico)
