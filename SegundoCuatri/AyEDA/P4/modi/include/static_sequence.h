 ...
 * @date 2026-03-22
 * @brief Generic implementation of a static sequence, used as a fixed-size
 * block to resolve overflows in the closed addressing hashing.
 */
...
template <class Key>
staticSequence<Key>::staticSequence(unsigned block_size) : block_size_{block_size}, data_{} {
